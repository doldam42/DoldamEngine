...
//REGISTER_CONTROLLER(TessellationDemoController)
...
BOOL TessellationDemoController::Start()
{
    ...
    wcscpy_s(groundMaterial.name, L"ground1");
    ...
    /*wcscpy_s(groundMaterial.name, L"ground1");
    wcscpy_s(groundMaterial.basePath, L"..\\..\\assets\\textures\\terrain\\");
    wcscpy_s(groundMaterial.heightTextureName, L"myfirstworld_th.png");*/
    ...
    Vector3 scale(64.0f, 2.0f, 64.0f);
