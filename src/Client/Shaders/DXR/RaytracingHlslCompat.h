...
struct AmbientOcclusionGBuffer
{
    ...
    XMFLOAT3 _virtualHitPosition; // virtual hitPosition in the previous frame.
                                  ...
                                  // For reflected points, this is a world position of a hit reflected across the
                                  // reflected surface
                                  //   ultimately giving the same screen space coords when projected and the depth
                                  //   corresponding to the ray depth.
...
#ifndef HLSL
static_assert(RayGroup::Width <= 64 && RayGroup::Height <= 128 && RayGroup::Size <= 8192,
