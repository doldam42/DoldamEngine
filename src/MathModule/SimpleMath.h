...
namespace DirectX
{
    namespace SimpleMath
    {
        ...
        struct Plane : public XMFLOAT4
        {
            ...
            float Distance(const Vector3 &position) const noexcept;
            bool IsOutside(const Vector3 &position) const noexcept;
            ...
            static Plane Transform(const Plane& plane, const Quaternion& rotation) noexcept;
                // Input quaternion must be the inverse transpose of the transformationn
        };
