...
BOOL BoxCollider::Initialize(IGameObject *pObj, const Vector3 center, const Vector3 extents)
{
    m_pIGameObject = pObj;
...
{
    const Vector3    pos = m_pIGameObject->GetPosition();
    const Quaternion q = m_pIGameObject->GetRotation();
