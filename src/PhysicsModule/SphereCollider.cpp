...
BOOL SphereCollider::Initialize(IGameObject *pObj, const Vector3 &center, const float radius)
{
    m_pIGameObject = pObj;
...
void SphereCollider::Update() { m_worldCenterOfMass = m_centerOfMass + m_pIGameObject->GetPosition(); }
